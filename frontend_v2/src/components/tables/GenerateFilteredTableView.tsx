...
import { Column, ColumnFiltersState, RowData, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, useReactTable,} from '@tanstack/react-table';
import axios from 'axios';
import { ResponseTypes, TableNames} from '../../types/TableTypes.ts';
import CreateFilteredColumnsMap from '../../services/CreateFilteredColumnsMap.tsx';
...
interface GenerateFilteredTableViewProps {
...
function GenerateFilteredTableView({ activeTable }: GenerateFilteredTableViewProps) {
  ...
  //const refreshData = () => setData((_old) => Client(50_000)); //stress test
    const columnsMap = CreateFilteredColumnsMap()
    ...
    React.useEffect(() => {
        getTableData(); // Вызовите fetchData здесь
    }, [activeTable]);
...
export default GenerateFilteredTableView
